 ...
 *
 * <p>
 * This interface and its corresponding implementation {@link ru.akimov.model.impl.FooModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ru.akimov.model.impl.FooImpl}.
 * </p>
 *
...
public interface FooModel extends BaseModel<Foo> {
    ...
    @Override
    public CacheModel<ru.akimov.model.Foo> toCacheModel();
