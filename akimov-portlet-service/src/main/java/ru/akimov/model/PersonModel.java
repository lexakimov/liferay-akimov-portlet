 ...
 *
 * <p>
 * This interface and its corresponding implementation {@link ru.akimov.model.impl.PersonModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link ru.akimov.model.impl.PersonImpl}.
 * </p>
 *
...
public interface PersonModel extends BaseModel<Person> {
    ...
    @Override
    public CacheModel<ru.akimov.model.Person> toCacheModel();
