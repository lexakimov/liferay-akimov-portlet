...
/**
 * Provides the local service interface for AuditEntryGroup. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see AuditEntryGroupLocalServiceUtil
...
public interface AuditEntryGroupLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link AuditEntryGroupLocalServiceUtil} to access the Группа записей аудита local service. Add custom service methods to {@link ru.akimov.service.impl.AuditEntryGroupLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
