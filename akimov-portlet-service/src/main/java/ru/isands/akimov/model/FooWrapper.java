...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
    ...
    */
    ...
    @Override
    public int compareTo(ru.isands.akimov.model.Foo foo) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<ru.isands.akimov.model.Foo> toCacheModel() {
        return _foo.toCacheModel();
    }

    @Override
    public ru.isands.akimov.model.Foo toEscapedModel() {
        return new FooWrapper(_foo.toEscapedModel());
    }

    @Override
    public ru.isands.akimov.model.Foo toUnescapedModel() {
