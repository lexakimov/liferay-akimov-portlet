...
public class PersonWrapper implements Person, ModelWrapper<Person> {
    ...
    */
    ...
    @Override
    public int compareTo(ru.isands.akimov.model.Person person) {
    ...
    @Override
    public com.liferay.portal.model.CacheModel<ru.isands.akimov.model.Person> toCacheModel() {
        return _person.toCacheModel();
    }

    @Override
    public ru.isands.akimov.model.Person toEscapedModel() {
        return new PersonWrapper(_person.toEscapedModel());
    }

    @Override
    public ru.isands.akimov.model.Person toUnescapedModel() {
