...
public class FooLocalServiceUtil {
    ...
    */
    public static ru.isands.akimov.model.Foo addFoo(
    ...
    * @return the new foo
    */
    public static ru.isands.akimov.model.Foo createFoo(int fooId) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.Foo deleteFoo(int fooId)
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.Foo deleteFoo(
        ru.isands.akimov.model.Foo foo)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static ru.isands.akimov.model.Foo fetchFoo(int fooId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.Foo getFoo(int fooId)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<ru.isands.akimov.model.Foo> getFoos(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.Foo updateFoo(
        ru.isands.akimov.model.Foo foo)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getService().updateFoo(foo);
    }

    public static ru.isands.akimov.model.FooBlobFieldBlobModel getBlobFieldBlobModel(
