...
public class AuditEntryLocalServiceUtil {
    ...
    */
    public static ru.isands.akimov.model.AuditEntry addAuditEntry(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<ru.isands.akimov.model.AuditEntry> getAuditEntries(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.AuditEntry updateAuditEntry(
        ru.isands.akimov.model.AuditEntry auditEntry)
        throws com.liferay.portal.kernel.exception.SystemException {
