...
public class PersonUtil {
    ...
    */
    public static java.util.List<ru.isands.akimov.model.Person> findByUuid(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.Person findByUuid_First(
        java.lang.String uuid,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException,
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.Person fetchByUuid_First(
        java.lang.String uuid,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.Person findByUuid_Last(
        java.lang.String uuid,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException,
            ru.isands.akimov.NoSuchPersonException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.Person fetchByUuid_Last(
        java.lang.String uuid,
        com.liferay.portal.kernel.util.OrderByComparator orderByComparator)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.Person[] findByUuid_PrevAndNext(
    ...
    */
    public static void cacheResult(ru.isands.akimov.model.Person person) {
    ...
    */
    public static ru.isands.akimov.model.Person create(int personId) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.Person remove(int personId)
        throws com.liferay.portal.kernel.exception.SystemException,
            ru.isands.akimov.NoSuchPersonException {
        return getPersistence().remove(personId);
    }

    public static ru.isands.akimov.model.Person updateImpl(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.Person findByPrimaryKey(int personId)
        throws com.liferay.portal.kernel.exception.SystemException,
            ru.isands.akimov.NoSuchPersonException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.Person fetchByPrimaryKey(int personId)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<ru.isands.akimov.model.Person> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static PersonPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (PersonPersistence) PortletBeanLocatorUtil.locate(ru.isands.akimov.service.ClpSerializer.getServletContextName(),
