...
public class EntityFieldChangeUtil {
    ...
    */
    public static ru.isands.akimov.model.EntityFieldChange create(int id) {
    ...
    */
    public static ru.isands.akimov.model.EntityFieldChange remove(int id)
        throws com.liferay.portal.kernel.exception.SystemException,
            ru.isands.akimov.NoSuchEntityFieldChangeException {
        return getPersistence().remove(id);
    }

    public static ru.isands.akimov.model.EntityFieldChange updateImpl(
        ru.isands.akimov.model.EntityFieldChange entityFieldChange)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.EntityFieldChange findByPrimaryKey(
        int id)
        throws com.liferay.portal.kernel.exception.SystemException,
            ru.isands.akimov.NoSuchEntityFieldChangeException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.EntityFieldChange fetchByPrimaryKey(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<ru.isands.akimov.model.EntityFieldChange> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static EntityFieldChangePersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (EntityFieldChangePersistence) PortletBeanLocatorUtil.locate(ru.isands.akimov.service.ClpSerializer.getServletContextName(),
