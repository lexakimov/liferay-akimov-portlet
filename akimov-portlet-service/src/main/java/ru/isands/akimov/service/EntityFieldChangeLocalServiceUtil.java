...
public class EntityFieldChangeLocalServiceUtil {
    ...
    */
    public static ru.isands.akimov.model.EntityFieldChange addEntityFieldChange(
    ...
    */
    public static ru.isands.akimov.model.EntityFieldChange createEntityFieldChange(
        int id) {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.EntityFieldChange deleteEntityFieldChange(
        int id)
    ...
    */
    ...
    public static ru.isands.akimov.model.EntityFieldChange fetchEntityFieldChange(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.EntityFieldChange getEntityFieldChange(
        int id)
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<ru.isands.akimov.model.EntityFieldChange> getEntityFieldChanges(
        int start, int end)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static ru.isands.akimov.model.EntityFieldChange updateEntityFieldChange(
        ru.isands.akimov.model.EntityFieldChange entityFieldChange)
        throws com.liferay.portal.kernel.exception.SystemException {
