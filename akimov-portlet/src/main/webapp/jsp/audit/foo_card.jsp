...
<aui:form name="fooForm" action="${submitFooFormURL}" method="POST">
	...
	<aui:input name="booleanField"
			   ...
			   value="${foo.booleanField}" type="checkbox"/>

	<aui:input name="shortField"
			   label="foo.field.shortField"
			   value="${foo.shortField}" cssClass="numeric-decimal" inlineField="true"/>

	<aui:input name="intField"
			   label="foo.field.intField"
			   value="${foo.intField}" cssClass="numeric-decimal" inlineField="true"/>

	<aui:input name="longField"
			   label="foo.field.longField"
			   value="${foo.longField}" cssClass="numeric-decimal"/>

	<aui:input name="floatField"
			   label="foo.field.floatField"
			   value="${foo.floatField}" cssClass="numeric-float" inlineField="true"/>

	<aui:input name="doubleField"
			   label="foo.field.doubleField"
			   value="${foo.doubleField}" cssClass="numeric-float" inlineField="true"/>
	...
	<aui:input name="dateField"
			   ...
			   value="${foo.dateField}" cssClass="date-dd-mm-yyyy" inlineField="true"/>
</aui:form>
