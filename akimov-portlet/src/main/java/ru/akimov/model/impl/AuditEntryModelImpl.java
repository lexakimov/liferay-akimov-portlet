...
/**
 * The base model implementation for the AuditEntry service. Represents a row in the &quot;akimov_audit_entries&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class AuditEntryModelImpl extends BaseModelImpl<AuditEntry>
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a audit entry model instance should use the {@link ru.akimov.model.AuditEntry} interface instead.
     */
    public static final String TABLE_NAME = "akimov_audit_entries";
    ...
    public static final String TABLE_SQL_CREATE = "create table akimov_audit_entries (auditEntryId INTEGER not null primary key,auditType VARCHAR(75) null,entityType VARCHAR(75) null,entityId INTEGER,companyId LONG,userId LONG,userName VARCHAR(75) null,dateOfChange DATE null,metadata TEXT null)";
    public static final String TABLE_SQL_DROP = "drop table akimov_audit_entries";
    public static final String ORDER_BY_JPQL = " ORDER BY auditEntry.auditEntryId ASC";
    public static final String ORDER_BY_SQL = " ORDER BY akimov_audit_entries.auditEntryId ASC";
