...
import ru.akimov.service.*;
import ru.akimov.service.impl.EntityFieldChangeLocalServiceImpl;
...
/**
 * Provides the base implementation for the entity field change local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link EntityFieldChangeLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see EntityFieldChangeLocalServiceImpl
...
public abstract class EntityFieldChangeLocalServiceBaseImpl
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link ru.akimov.service.EntityFieldChangeLocalServiceUtil} to access the entity field change local service.
     */
     ...
     */
    @Override
    public EntityFieldChange createEntityFieldChange(int id) {
        return entityFieldChangePersistence.create(id);
    }
    ...
    @Override
    public EntityFieldChange deleteEntityFieldChange(int id)
        throws PortalException, SystemException {
        return entityFieldChangePersistence.remove(id);
    }
    ...
    @Override
    public EntityFieldChange fetchEntityFieldChange(int id)
        throws SystemException {
        return entityFieldChangePersistence.fetchByPrimaryKey(id);
    }
    ...
    public EntityFieldChange getEntityFieldChange(int id)
        throws PortalException, SystemException {
        return entityFieldChangePersistence.findByPrimaryKey(id);
    }
