...
import ru.akimov.service.AuditEntryGroupLocalService;
...
/**
 * Provides the base implementation for the Группа записей аудита local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ru.akimov.service.impl.AuditEntryGroupLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see ru.akimov.service.impl.AuditEntryGroupLocalServiceImpl
 * @see ru.akimov.service.AuditEntryGroupLocalServiceUtil
 * @generated
 */
public abstract class AuditEntryGroupLocalServiceBaseImpl
    extends BaseLocalServiceImpl implements AuditEntryGroupLocalService,
        IdentifiableBean {
    ...
    private AuditEntryGroupLocalServiceClpInvoker _clpInvoker = new AuditEntryGroupLocalServiceClpInvoker();

    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link ru.akimov.service.AuditEntryGroupLocalServiceUtil} to access the Группа записей аудита local service.
     */
    ...
    @Override
    public AuditEntryGroup addAuditEntryGroup(AuditEntryGroup auditEntryGroup)
        throws SystemException {
        auditEntryGroup.setNew(true);

        return auditEntryGroupPersistence.update(auditEntryGroup);
    }
     ...
     */
    @Override
    public AuditEntryGroup createAuditEntryGroup(int entryGroupId) {
        return auditEntryGroupPersistence.create(entryGroupId);
    }
    ...
    @Override
    public AuditEntryGroup deleteAuditEntryGroup(int entryGroupId)
        throws PortalException, SystemException {
        return auditEntryGroupPersistence.remove(entryGroupId);
    }
    ...
    @Indexable(type = IndexableType.DELETE)
    @Override
    public AuditEntryGroup deleteAuditEntryGroup(
        AuditEntryGroup auditEntryGroup) throws SystemException {
        return auditEntryGroupPersistence.remove(auditEntryGroup);
    }
    ...
    public DynamicQuery dynamicQuery() {
        ...
        return DynamicQueryFactoryUtil.forClass(AuditEntryGroup.class,
    ...
    public List dynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
        return auditEntryGroupPersistence.findWithDynamicQuery(dynamicQuery);
    }
    ...
    public long dynamicQueryCount(DynamicQuery dynamicQuery)
        throws SystemException {
        return auditEntryGroupPersistence.countWithDynamicQuery(dynamicQuery);
    }
    ...
    @Override
    public AuditEntryGroup fetchAuditEntryGroup(int entryGroupId)
        throws SystemException {
        return auditEntryGroupPersistence.fetchByPrimaryKey(entryGroupId);
    }
     ...
     */
    @Override
    public AuditEntryGroup getAuditEntryGroup(int entryGroupId)
        throws PortalException, SystemException {
        return auditEntryGroupPersistence.findByPrimaryKey(entryGroupId);
    }

    @Override
    public PersistedModel getPersistedModel(Serializable primaryKeyObj)
        throws PortalException, SystemException {
        return auditEntryGroupPersistence.findByPrimaryKey(primaryKeyObj);
    }
     ...
     */
    @Override
    public List<AuditEntryGroup> getAuditEntryGroups(int start, int end)
        throws SystemException {
        return auditEntryGroupPersistence.findAll(start, end);
    }
     ...
     */
    @Override
    public int getAuditEntryGroupsCount() throws SystemException {
        return auditEntryGroupPersistence.countAll();
    }
    ...
    @Indexable(type = IndexableType.REINDEX)
    @Override
    public AuditEntryGroup updateAuditEntryGroup(
        AuditEntryGroup auditEntryGroup) throws SystemException {
        return auditEntryGroupPersistence.update(auditEntryGroup);
    }
    ...
    public void afterPropertiesSet() {
        ...
        PersistedModelLocalServiceRegistryUtil.register("ru.akimov.model.AuditEntryGroup",
            auditEntryGroupLocalService);
    }

    public void destroy() {
        PersistedModelLocalServiceRegistryUtil.unregister(
            "ru.akimov.model.AuditEntryGroup");
    }
    ...
    protected void runSQL(String sql) throws SystemException {
        try {
            DataSource dataSource = auditEntryGroupPersistence.getDataSource();
