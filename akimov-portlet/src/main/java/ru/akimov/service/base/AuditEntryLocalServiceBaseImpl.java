...
/**
 * Provides the base implementation for the Запись аудита local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link ru.akimov.service.impl.AuditEntryLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see ru.akimov.service.impl.AuditEntryLocalServiceImpl
 * @see ru.akimov.service.AuditEntryLocalServiceUtil
 * @generated
 */
public abstract class AuditEntryLocalServiceBaseImpl
     ...
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. Always use {@link ru.akimov.service.AuditEntryLocalServiceUtil} to access the Запись аудита local service.
     */
     ...
     */
    @Override
    public AuditEntry createAuditEntry(int entryId) {
        return auditEntryPersistence.create(entryId);
    }
    ...
    @Override
    public AuditEntry deleteAuditEntry(int entryId)
        throws PortalException, SystemException {
        return auditEntryPersistence.remove(entryId);
    }
    ...
    @Override
    public AuditEntry fetchAuditEntry(int entryId) throws SystemException {
        return auditEntryPersistence.fetchByPrimaryKey(entryId);
    }
     ...
     */
    @Override
    public AuditEntry getAuditEntry(int entryId)
        throws PortalException, SystemException {
        return auditEntryPersistence.findByPrimaryKey(entryId);
    }
